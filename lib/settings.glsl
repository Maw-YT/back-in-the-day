...
#define COMPOSITE_LOWRES 1.0 //[0.0 1.0]
#define COMPOSITE_QUANTIZE 1.0 //[0.0 1.0]
...
#define FOG_DISTANCE 32.0 //[12.0 20.0 28.0 40.0 64.0 96.0]
#define FOG_DENSITY 0.08 //[0.04 0.06 0.08 0.10 0.12 0.16 0.20]
#define FOG_BANDS 8.0 //[4.0 6.0 8.0 12.0 16.0 32.0]
#define SKY_FOG_STRENGTH 0.50 //[0.20 0.35 0.50 0.65 0.80 1.00]
#define SKY_QUANTIZE 1.0 //[0.0 1.0]
#define SKY_BANDS 8.0 //[4.0 6.0 8.0 12.0 16.0]
...
#define LIGHT_LEVEL_STEPS 16.0 //[4.0 6.0 8.0 12.0 16.0]
